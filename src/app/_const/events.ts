export const events = {
  ...
  "swap_confirm": {
    ...
    "button_swap_cancel_*FROM_ASSET*_*TO_ASSET*_usd_*numerical_usd_value*": {
      "label": "button_swap_cancel_*FROM_ASSET*_*TO_ASSET*_usd_*numerical_usd_value*",
      "category": "swap_confirm",
      "action": "skip_swap",
      "thorwallet": true,
      "value": true
    ...
    "button_swap_cancel_*FROM_ASSET*_*TO_ASSET*_slip_%_*numerical_%_value*": {
      "label": "button_swap_cancel_*FROM_ASSET*_*TO_ASSET*_slip_%_*numerical_%_value*",
      "category": "swap_confirm",
      "action": "skip_swap",
      "thorwallet": true,
      "value": true
  ...
  "pool_deposit_symmetrical_prepare": {
    ...
    "button_deposit_symmetrical_*POOL_ASSET*_usd_*numerical_usd_value*": {
      "label": "button_deposit_symmetrical_*POOL_ASSET*_usd_*numerical_usd_value*",
      "category": "pool_deposit_symmetrical_prepare",
      "action": "skip_pool",
      "thorwallet": true,
      "value": true
  ...
  "pool_deposit_symmetrical_confirm": {
    ...
    "button_deposit_confirm_symmetrical_*POOL_ASSET*_usd_*numerical_usd_value*": {
      "label": "button_deposit_confirm_symmetrical_*POOL_ASSET*_usd_*numerical_usd_value*",
      "category": "pool_deposit_symmetrical_confirm",
      "action": "skip_pool",
      "thorwallet": true,
      "value": true
  ...
  "transaction_select": {
    ...
    "option_selected_swap_*FROM_ASSET*_*TO_ASSET*_tag_txid_explore_*ASSET*": {
      "label": "option_selected_swap_*FROM_ASSET*_*TO_ASSET*_tag_txid_explore_*ASSET*",
      "category": "transaction_select",
      "action": "skip_transactions",
      "thorwallet": true,
      "value": false
